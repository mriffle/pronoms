...
def scale_data(
    data: np.ndarray, method: str = "standard", axis: int = 0, with_mean: bool = True, with_std: bool = True
) -> np.ndarray:
    """
    ...
    if method == "standard":
        ...
        raise ValueError(f"Invalid scaling method: {method}. Use 'standard', 'minmax', 'robust', or 'l2'.")
